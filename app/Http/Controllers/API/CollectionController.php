...
class CollectionController extends Controller
{
    ...
    {
        return Collection::latest()->paginate(env('PAGE_NO', '10'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $st = DB::table('collections')->insert($data);
    ...
    {
        return Collection::select('id', 'name')->get();
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = Collection::where('id', '=', $id)->firstOrFail();
        ...
        {
            return ('Error! Collection Not Updated.');
        }
    }
    ...
    public function search($query){
        if ($query) {
            $searchData = Collection::where('name','LIKE', '%'.$query.'%')->select('slug', 'name', 'id', 'status')
    ...
    function import(Request $request)
    {
      ...
      foreach($realdata as $value)
      {
        ...
        {
            DB::table('collections')->insert($insert_data);
        }
      }
