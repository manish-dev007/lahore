                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="product-default mb-4">
                            <figure>
                                ...
                                <a href="https://api.whatsapp.com/send?phone=+919999999999&text=Hi,I am Interested in {{ $data[0]->name }} <?php echo $item['model_no']; ?> Watch." target="_blank" class="whatsapp_ico">
                ...
                if(res[0]!=""){
                    $.each(res[0], function(key, value) {
                        ...
                        if (value != null){
                            ...
                            row+="<a href='"+site_url+"/product/"+value.product_id+"'>"+value.name+"</a>"
                                row+="<p>("+value.model_no+")</p>"
                            row+="</h2>"
                            ...
                            row+="<div class='btn_cart_block action_btn_cart-"+value.product_id+"'>"
                                if(value.cart_id != 0){
                                    row+="<a href='javascript:void(0);' class='btn btn-success btn_cart'>Added to Cart</a>"
                                }
                                else{
                                    row+="<a href='javascript:void(0);' onclick='addToCart("+value.product_id+");' class='btn btn-secondary btn_cart'>Add to cart</a>"
                                }
