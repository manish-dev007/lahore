			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="editMode" id="exampleModalLabel">Update Page`s Info</h5>
						<h5 class="modal-title" v-show="!editMode" id="exampleModalLabel">Add Page`s Info</h5>
					...
					<div class="modal-body">
						<div class="row">
                            ...
                            <div class="col-md-12 col-lg-6 form-group">
                                <label for="header_img" class="control-label">Page Photo</label><br>
...
export default {
	...
	methods: {
        ...
        getPagePhoto(){
            let photo = (this.form.header_img.length > 200) ? this.form.header_img : "storage/app/header_image/"+ this.form.header_img ;
            return photo;
        },
		loadPageData () {
			this.$Progress.start();
