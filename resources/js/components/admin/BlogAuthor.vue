			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="editMode" id="exampleModalLabel">Update Blog Author`s Info</h5>
						<h5 class="modal-title" v-show="!editMode" id="exampleModalLabel">Add Blog Author`s Info</h5>
