	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="#" class="kt-subheader__breadcrumbs-link">Clock Types</a>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="editMode" id="exampleModalLabel">Update Clock Types`s Info</h5>
						<h5 class="modal-title" v-show="!editMode" id="exampleModalLabel">Add Clock Types`s Info</h5>
	...
	methods: {
		...
		updatePageData () {
			...
			.then(()=>{
				...
				Toast.fire({
					icon: 'success',
					title: 'Clock Type Updated Successfully'
				});
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Clock Type Not Updated'
				});
				this.$Progress.fail();
			})
		},
		...
		createPage () {
			...
			.then(()=>{
				...
				Toast.fire({
					icon: 'success',
					title: 'Clock Type Created Successfully'
				});
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Clock Type Not Created'
				});
				this.$Progress.fail();
			})
		},
