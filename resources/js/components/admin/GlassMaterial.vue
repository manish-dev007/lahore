	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="#" class="kt-subheader__breadcrumbs-link">Glass Materials</a>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="editMode" id="exampleModalLabel">Update Glass Material`s Info</h5>
						<h5 class="modal-title" v-show="!editMode" id="exampleModalLabel">Add Glass Material`s Info</h5>
	...
	methods: {
		...
		updatePageData () {
			...
			.then(()=>{
				...
				Toast.fire({
					icon: 'success',
					title: 'Glass Material Updated Successfully'
				});
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Glass Material Not Updated'
				});
				this.$Progress.fail();
			})
		},
		...
		createPage () {
			...
			.then(()=>{
				...
				Toast.fire({
					icon: 'success',
					title: 'Glass Material Created Successfully'
				});
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Glass Material Not Created'
				});
				this.$Progress.fail();
			})
		},
