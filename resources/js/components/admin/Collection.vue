	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="#" class="kt-subheader__breadcrumbs-link">Collections</a>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="editMode" id="exampleModalLabel">Update Collection`s Info</h5>
						<h5 class="modal-title" v-show="!editMode" id="exampleModalLabel">Add Collection`s Info</h5>
	...
	methods: {
		...
		updatePageData () {
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Collection Not Updated'
				});
				this.$Progress.fail();
			})
		},
