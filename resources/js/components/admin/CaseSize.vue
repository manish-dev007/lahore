	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="#" class="kt-subheader__breadcrumbs-link">Case Sizes</a>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="editMode" id="exampleModalLabel">Update Case Size`s Info</h5>
						<h5 class="modal-title" v-show="!editMode" id="exampleModalLabel">Add Case Size`s Info</h5>
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-md-12 form-group">
								...
								<input v-model="form.case_size" type="text" name="case_size" class="form-control" :class="{ 'is-invalid': form.errors.has('case_size') }">
								<has-error :form="form" field="case_size"></has-error>
							</div>
							<div class="col-md-12 form-group">
								<label>Slug</label>
	...
	methods: {
		...
		updatePageData () {
			...
			.then(()=>{
				...
				Toast.fire({
					icon: 'success',
					title: 'Case Size Updated Successfully'
				});
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Case Size Not Updated'
				});
				this.$Progress.fail();
			})
		},
		...
		createPage () {
			...
			.then(()=>{
				...
				Toast.fire({
					icon: 'success',
					title: 'Case Size Created Successfully'
				});
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Case Size Not Created'
				});
				this.$Progress.fail();
			})
		},
