	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="#" class="kt-subheader__breadcrumbs-link">Main Categories</a>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="editMode" id="exampleModalLabel">Update Main Category`s Info</h5>
						<h5 class="modal-title" v-show="!editMode" id="exampleModalLabel">Add Main Category`s Info</h5>
	...
	methods: {
		...
		updatePageData () {
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Main Category Not Updated'
				});
				this.$Progress.fail();
			})
		},
		...
		createPage () {
			...
			.then(()=>{
				...
				Toast.fire({
					icon: 'success',
					title: 'Main Category Created Successfully'
				});
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Main Category Not Created'
				});
				this.$Progress.fail();
			})
		},
