	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="#" class="kt-subheader__breadcrumbs-link">Movements</a>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="editMode" id="exampleModalLabel">Update Movement`s Info</h5>
						<h5 class="modal-title" v-show="!editMode" id="exampleModalLabel">Add Movement`s Info</h5>
	...
	methods: {
		...
		updatePageData () {
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Movement Not Updated'
				});
				this.$Progress.fail();
			})
		},
		...
		createPage () {
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Movement Not Created'
				});
				this.$Progress.fail();
			})
		},
