	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="#" class="kt-subheader__breadcrumbs-link">Strap Colours</a>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="editMode" id="exampleModalLabel">Update Strap Colour`s Info</h5>
						<h5 class="modal-title" v-show="!editMode" id="exampleModalLabel">Add Strap Colour`s Info</h5>
	...
	methods: {
		...
		updatePageData () {
			...
			.then(()=>{
				...
				Toast.fire({
					icon: 'success',
					title: 'Strap Colour Updated Successfully'
				});
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Strap Colour Not Updated'
				});
				this.$Progress.fail();
			})
		},
		...
		createPage () {
			...
			.then(()=>{
				...
				Toast.fire({
					icon: 'success',
					title: 'Strap Colour Created Successfully'
				});
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Strap Colour Not Created'
				});
				this.$Progress.fail();
			})
		},
