	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="#" class="kt-subheader__breadcrumbs-link">Customers</a>
										...
										<table class="table table-hover">
											...
											<tbody>
												<tr v-for="item in pages.data" :key="item.id">
													...
													<td><a href="#" class="btn btn-outline-warning btn-elevate btn-icon" @click="fetchAddressData(item.id);"><i class="flaticon-search"></i></a></td>
												</tr>
											</tbody>
										</table>
										<table class="table table-hover">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">User Addresses List</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						</button>
					</div>
					<form @submit.prevent="editMode ? fetchAddressData() : createPage()">
					<div class="modal-body">
						<div class="row">
							<div class="col-md-12">
								<div class="address_list" v-html="address_list">
										{{ address_list }}
								</div>
							</div>
						</div>
	...
	methods: {
		...
		updatePageData () {
			...
			.then(()=>{
				...
				Toast.fire({
					icon: 'success',
					title: 'Blog Author Updated Successfully'
				});
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Blog Author Not Updated'
				});
				this.$Progress.fail();
			})
		},
		...
		createPage () {
			...
			.then(()=>{
				...
				Toast.fire({
					icon: 'success',
					title: 'Blog Author Created Successfully'
				});
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Blog Author Not Created'
				});
				this.$Progress.fail();
			})
		},
