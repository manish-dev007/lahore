			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="editMode" id="exampleModalLabel">Update Seo Tag`s Info</h5>
						<h5 class="modal-title" v-show="!editMode" id="exampleModalLabel">Add Seo Tag`s Info</h5>
	...
	methods: {
		...
		updatePageData () {
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Seo Tag Not Updated'
				});
				this.$Progress.fail();
			})
		},
		...
		createPage () {
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Seo Tag Not Created'
				});
				this.$Progress.fail();
			})
		},
