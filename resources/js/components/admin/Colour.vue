	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="#" class="kt-subheader__breadcrumbs-link">Colours</a>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="editMode" id="exampleModalLabel">Update Colour`s Info</h5>
						<h5 class="modal-title" v-show="!editMode" id="exampleModalLabel">Add Colour`s Info</h5>
	...
	methods: {
		...
		updatePageData () {
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Colour Not Updated'
				});
				this.$Progress.fail();
			})
		},
		...
		createPage () {
			...
			.catch(()=>{
				Toast.fire({
					icon: 'error',
					title: 'Error! Colour Not Created'
				});
				this.$Progress.fail();
			})
		},
